...
(
    ...
    if [[ -f "${DORIS_HOME}"/ms/conf/selectdb_cloud.conf && ! -f "${DORIS_HOME}"/ms/conf/selectdb_cloud.conf ]]; then
        ln -s "${DORIS_HOME}"/ms/conf/selectdb_cloud.conf "${DORIS_HOME}"/ms/conf/selectdb_cloud.conf
    fi
    if [[ -f "${DORIS_HOME}"/ms/conf/selectdb_cloud.conf && ! -f "${DORIS_HOME}"/ms/conf/selectdb_cloud.conf ]]; then
        ln -s "${DORIS_HOME}"/ms/conf/selectdb_cloud.conf "${DORIS_HOME}"/ms/conf/selectdb_cloud.conf
    fi
    ...
    cat "${teamcity_build_checkoutDir}"/regression-test/pipeline/vault_p0/conf/ms_custom.conf >>"${DORIS_HOME}"/ms/conf/selectdb_cloud.conf
    echo >>"${DORIS_HOME}"/ms/conf/selectdb_cloud.conf
    cat "${teamcity_build_checkoutDir}"/regression-test/pipeline/vault_p0/conf/recycler_custom.conf >>"${DORIS_HOME}"/recycler/conf/selectdb_cloud.conf
